...
func TestRestClient_ReplaceDocument_SubPartitions(t *testing.T) {
	...
	if result := client.CreateDocument(gocosmos.DocumentSpec{DbName: dbname, CollName: collname, PartitionKeyValues: []interface{}{"app", "user"}, DocumentData: docInfo}); result.Error() != nil {
		t.Fatalf("%s failed: %s", name, result.Error())
	...
	if result := client.ReplaceDocument("", gocosmos.DocumentSpec{DbName: dbname, CollName: collname, PartitionKeyValues: []interface{}{"app", "user"}, DocumentData: docInfo}); result.CallErr != nil {
		t.Fatalf("%s failed: %s", name, result.CallErr)
	} else if result.StatusCode != 409 {
	...
	if result := client.ReplaceDocument("", gocosmos.DocumentSpec{DbName: dbname, CollName: collname, PartitionKeyValues: []interface{}{"app", "user"}, DocumentData: docInfo}); result.Error() != nil {
		t.Fatalf("%s failed: %s", name, result.Error())
	} else if result.DocInfo["id"] != docInfo["id"] || result.DocInfo["app"] != docInfo["app"] || result.DocInfo["username"] != docInfo["username"] ||
		result.DocInfo["email"] != docInfo["email"] || result.DocInfo["grade"] != docInfo["grade"] || result.DocInfo["active"] != docInfo["active"] ||
		result.DocInfo["_rid"] == "" || result.DocInfo["_self"] == "" || result.DocInfo["_ts"].(float64) == 0.0 || result.DocInfo["_etag"] == "" || result.DocInfo["_attachments"] == "" {
	...
	docInfo["grade"] = 3.0
	docInfo["active"] = true
	if result := client.ReplaceDocument(etag+"dummy", gocosmos.DocumentSpec{DbName: dbname, CollName: collname, PartitionKeyValues: []interface{}{"app", "user"}, DocumentData: docInfo}); result.CallErr != nil {
		t.Fatalf("%s failed: %s", name, result.CallErr)
	...
	if result := client.ReplaceDocument(etag, gocosmos.DocumentSpec{DbName: dbname, CollName: collname, PartitionKeyValues: []interface{}{"app", "user"}, DocumentData: docInfo}); result.Error() != nil {
		t.Fatalf("%s failed: %s", name, result.Error())
	} else if result.DocInfo["id"] != docInfo["id"] || result.DocInfo["app"] != docInfo["app"] || result.DocInfo["username"] != docInfo["username"] ||
		result.DocInfo["email"] != docInfo["email"] || result.DocInfo["grade"] != docInfo["grade"] || result.DocInfo["active"] != docInfo["active"] ||
		result.DocInfo["_rid"] == "" || result.DocInfo["_self"] == "" || result.DocInfo["_ts"].(float64) == 0.0 || result.DocInfo["_etag"] == "" || result.DocInfo["_attachments"] == "" {
...
func TestRestClient_ReplaceDocumentCrossPartitions_SubPartitions(t *testing.T) {
	...
	if result := client.CreateDocument(gocosmos.DocumentSpec{DbName: dbname, CollName: collname, PartitionKeyValues: []interface{}{"app", "user1"}, DocumentData: docInfo}); result.Error() != nil {
		t.Fatalf("%s failed: %s", name, result.Error())
	} else if result.DocInfo["id"] != docInfo["id"] || result.DocInfo["app"] != docInfo["app"] || result.DocInfo["username"] != docInfo["username"] ||
		result.DocInfo["email"] != docInfo["email"] || result.DocInfo["grade"] != docInfo["grade"] || result.DocInfo["active"] != docInfo["active"] ||
		result.DocInfo["_rid"] == "" || result.DocInfo["_self"] == "" || result.DocInfo["_ts"].(float64) == 0.0 || result.DocInfo["_etag"] == "" || result.DocInfo["_attachments"] == "" {
	...
	if result := client.ReplaceDocument("", gocosmos.DocumentSpec{DbName: dbname, CollName: collname, PartitionKeyValues: []interface{}{"app", "user2"}, DocumentData: docInfo}); result.CallErr != nil {
		t.Fatalf("%s failed: %s", name, result.CallErr)
	} else if result.StatusCode != 404 {
		t.Fatalf("%s failed: <status-code> expected %#v but received %#v", name, 404, result.StatusCode)
	}
	...
	docInfo["username"] = "user2"
	if result := client.ReplaceDocument("", gocosmos.DocumentSpec{DbName: dbname, CollName: collname, PartitionKeyValues: []interface{}{"app", "user1"}, DocumentData: docInfo}); result.CallErr != nil {
		t.Fatalf("%s failed: %s", name, result.CallErr)
...
func TestRestClient_GetDocument_SubPartitions(t *testing.T) {
	...
	if result := client.GetDocument(gocosmos.DocReq{DbName: dbname, CollName: collname, DocId: "1", PartitionKeyValues: []interface{}{"app", "user"}}); result.Error() != nil {
		t.Fatalf("%s failed: %s", name, result.Error())
	} else if result.DocInfo.Id() != docInfo["id"] || result.DocInfo["app"] != docInfo["app"] || result.DocInfo["username"] != docInfo["username"] ||
		result.DocInfo["email"] != docInfo["email"] || result.DocInfo["grade"] != docInfo["grade"] || result.DocInfo["active"] != docInfo["active"] ||
	...
	if result := client.GetDocument(gocosmos.DocReq{NotMatchEtag: etag, DbName: dbname, CollName: collname, DocId: "1", PartitionKeyValues: []interface{}{"app", "user"}}); result.CallErr != nil {
		t.Fatalf("%s failed: %s", name, result.CallErr)
	} else if result.StatusCode != 304 {
		t.Fatalf("%s failed: <status-code> expected %#v but received %#v", name, 304, result.StatusCode)
	}

	if result := client.GetDocument(gocosmos.DocReq{DbName: dbname, CollName: collname, DocId: "0", PartitionKeyValues: []interface{}{"app", "user"}}); result.CallErr != nil {
		t.Fatalf("%s failed: %s", name, result.CallErr)
	} else if result.StatusCode != 404 {
		t.Fatalf("%s failed: <status-code> expected %#v but received %#v", name, 404, result.StatusCode)
	}
...
func TestRestClient_DeleteDocument_SubPartitions(t *testing.T) {
	...
	if result := client.DeleteDocument(gocosmos.DocReq{MatchEtag: etag + "dummy", DbName: dbname, CollName: collname, DocId: "1", PartitionKeyValues: []interface{}{"app", "user"}}); result.CallErr != nil {
		t.Fatalf("%s failed: %s", name, result.CallErr)
	} else if result.StatusCode != 412 {
		t.Fatalf("%s failed: <status-code> expected %#v but received %#v", name, 404, result.StatusCode)
	}
	if result := client.DeleteDocument(gocosmos.DocReq{MatchEtag: etag, DbName: dbname, CollName: collname, DocId: "1", PartitionKeyValues: []interface{}{"app", "user"}}); result.Error() != nil {
		t.Fatalf("%s failed: %s", name, result.Error())
	}
	...
	if result := client.DeleteDocument(gocosmos.DocReq{DbName: dbname, CollName: collname, DocId: "1", PartitionKeyValues: []interface{}{"app", "user"}}); result.Error() != nil {
		t.Fatalf("%s failed: %s", name, result.Error())
	}

	if result := client.DeleteDocument(gocosmos.DocReq{DbName: dbname, CollName: collname, DocId: "1", PartitionKeyValues: []interface{}{"app", "user"}}); result.CallErr != nil {
		t.Fatalf("%s failed: %s", name, result.CallErr)
	} else if result.StatusCode != 404 {
		t.Fatalf("%s failed: <status-code> expected %#v but received %#v", name, 404, result.StatusCode)
	}
